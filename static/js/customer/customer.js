...
function checkForm(form) {
  if ($("#imageUpload").val() == "") {
    $("#imageUpload")
      .parent()
      .append('<span class="error">Please upload image.</span>')
      .addClass("has-error");
    return false;
  }
  ...
  if ($("#country_code").val() == "") {
    $("#country_code")
      .parent()
      .append('<span class="error">Please enter Country code.</span>')
      .addClass("has-error");
    return false;
  }
  ...
  if ($("#password").val().length < 12) {
    $("#password")
      .parent()
      .append(
        '<span class="error">Password should be minimum 12 characters.</span>'
      )
      .addClass("has-error");
    return false;
  }
...
function editUser(id) {
  ...
  sessionStorage.setItem(whichScope, "parent");
